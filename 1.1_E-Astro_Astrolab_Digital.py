...
def update_gui():
    ...
    # Gambar pointer Matahari (merah) dan tambahkan keterangan
    ...
    # Gambar pointer Bulan (biru) dan tambahkan keterangan
...
# (Optional) Tombol untuk memaksa refresh peta langit
btn_refresh = tk.Button(frame_input, text="Refresh Peta Langit", command=update_star_map)
...
frame_star_map = tk.Frame(window)
frame_star_map.pack(pady=10)

# Buat figure matplotlib untuk peta langit
